...
export const APK_VERSION = "1.05";
/** Approx size for UI copy. */
export const APK_SIZE_LABEL = "~88 MB";
/**
...
export const GITHUB_RELEASE_TAG = "apk-release-1.05";
...
export const BUILD_ID = "2026.07.30-release-1.05-site-gfx";
