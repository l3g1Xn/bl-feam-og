...
export const GITHUB_RELEASE_TAG = "apk-release-1.04";
...
export const GITHUB_RELEASE_PAGE =
  "https://github.com/l3g1Xn/bl-feam-og/releases/tag/apk-release-1.04";

/** Bump when shipping site+APK together so players can confirm sync. */
export const BUILD_ID = "2026.07.30-release-1.04";
