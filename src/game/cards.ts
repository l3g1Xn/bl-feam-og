...
export const CARD_POOL: CardDef[] = [
  ...
  // —— New stock (pool) ——
  {
    ...
    attack: 2,
    health: 4,
    text: "Taunt. Rush. Perimeter pulse armor.",
    keywords: ["taunt", "rush"],
    art: "steel",
  },
  {
    ...
    attack: 5,
    health: 2,
    text: "Rush. Long-range coil rail.",
    keywords: ["rush"],
    art: "arcane",
  },
  {
    ...
    attack: 1,
    health: 4,
    text: "Taunt. Shield. Ice-lattice barrier.",
  ...
  },
  {
    ...
    cost: 2,
    type: "spell",
    text: "Deal 1 to all enemy minions (ion mesh).",
    spell: { kind: "damage", amount: 1, target: "all_enemy_minions" },
    art: "arcane",
  },
  ...
  // —— New store stock ——
  {
    ...
    attack: 3,
    health: 3,
    text: "Charge. Shield. Phase-cloak flanks.",
  ...
  },
  {
    ...
    type: "spell",
    storeExclusive: true,
    text: "Restore 6 health to your hero (quantum lattice).",
  ...
  },
  {
    ...
    type: "spell",
    storeExclusive: true,
    text: "Deal 7 (+Spell Power) to an enemy minion.",
    spell: { kind: "damage", amount: 7, target: "enemy_minion" },
    art: "ember",
  },
  {
    id: "aegis_phalanx",
    ...
    attack: 4,
    health: 8,
    text: "Taunt. Shield. Reborn. Legion wall protocol.",
