 ...
 * GitHub URL matches bl-feam-og release apk-release-1.0.2.
 */
...
export async function downloadApk(
  ...
  try {
    ...
    // 1) Chunked /pkg — same binary as GitHub release 1.0.2
    try {
    ...
    // 3) GitHub release (bl-feam-og apk-release-1.0.2) — same package
