 ...
 * GitHub URL matches bl-feam-og release apk-release-1.06.666.
 */
...
export async function downloadApk(
  ...
  try {
    ...
    // 1) Chunked /pkg — same binary as GitHub release 1.06.666
    try {
    ...
    // 3) GitHub release apk-release-1.06.666 — same package
